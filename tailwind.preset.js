  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        redHatMono: ["var(--font-red-hat-mono)", ...fontFamily.sans],
      },
      screens: {
        xxxs: "325px", // mobile small
        xxs: "375px", // mobile medium
      ...
      colors: {
        ...
        "gradient-linear-30":
          "linear-gradient(113deg, rgba(255, 255, 255, 0.30) 3.51%, rgba(255, 255, 255, 0.00) 111.71%), rgba(240, 240, 240, 0.33)",
      },
      keyframes: {
        "rotate-up": {
          "0%": {

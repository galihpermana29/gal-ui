...
export type {
  OSXModalWrapperProps as OSModalWrapperProps,
} from './components/Modal/OSXModalWrapper';
...
export type {
  OSXResponsiveModalDrawerProps as OSResponsiveModalDrawerProps,
} from './components/ResponsiveModalDrawer/OSXResponsiveModalDrawer';
...
// Styles entry (consumers: import '@synergysg/ui-components/styles.css')
